...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
static volatile uint8_t psola_reset_flag = 2;
static const uint16_t num_modes = 2;
static const float change_factors[2][2] = {
	{12.0f, 4.0f},
	{-13.0f, -3.0f}
};
static volatile uint16_t mode = 0;
/* USER CODE END PV */
